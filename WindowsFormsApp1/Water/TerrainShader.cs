...
{
    public class TerrainShader                 // 302 lines
    {
        // Structures
        ...
        private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                ShaderBytecode vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "TerrainVertexShader", GameConfig.VertexShaderProfile, ShaderFlags.None, EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "TerrainPixelShader", GameConfig.PixelShaderProfile, ShaderFlags.None, EffectFlags.None);
